...
INSERT INTO "new_Team" ("academicReputation", "athleticDirectorId", "baseSalary", "conferenceId", "division", "facilitiesRating", "headCoachId", "id", "internationalScoutingRating", "isPlayerControlled", "name", "nilBudget", "prestige", "saveGameId", "state", "venueCapacity") SELECT "academicReputation", "athleticDirectorId", "baseSalary", "conferenceId", "division", "facilitiesRating", "headCoachId", "id", "internationalScoutingRating", "isPlayerControlled", "name", "nilBudget", "prestige", "saveGameId", "state", "venueCapacity" FROM "Team";
DROP TABLE "Team";
