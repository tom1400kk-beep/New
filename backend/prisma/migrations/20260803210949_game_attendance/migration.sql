-- AlterTable
ALTER TABLE "Game" ADD COLUMN "attendance" INTEGER;
...
INSERT INTO "new_Team" ("academicReputation", "athleticDirectorId", "baseSalary", "conferenceId", "division", "facilitiesRating", "headCoachId", "id", "internationalScoutingRating", "isPlayerControlled", "name", "nilBudget", "prestige", "saveGameId", "state") SELECT "academicReputation", "athleticDirectorId", "baseSalary", "conferenceId", "division", "facilitiesRating", "headCoachId", "id", "internationalScoutingRating", "isPlayerControlled", "name", "nilBudget", "prestige", "saveGameId", "state" FROM "Team";
DROP TABLE "Team";
