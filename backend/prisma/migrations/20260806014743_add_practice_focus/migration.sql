...
CREATE TABLE "new_Team" (
    ...
    "practiceFocus" TEXT NOT NULL DEFAULT 'BALANCED',
    "headCoachId" TEXT,
...
INSERT INTO "new_Team" ("academicReputation", "arenaUpgradeRequestedThisSeason", "athleticDirectorId", "baseSalary", "city", "conferenceId", "depthChartJson", "division", "facilitiesRating", "headCoachId", "id", "internationalScoutingRating", "internationalTourCountry", "internationalTourSeasonYear", "isPlayerControlled", "name", "nilBudget", "prestige", "saveGameId", "state", "venueCapacity") SELECT "academicReputation", "arenaUpgradeRequestedThisSeason", "athleticDirectorId", "baseSalary", "city", "conferenceId", "depthChartJson", "division", "facilitiesRating", "headCoachId", "id", "internationalScoutingRating", "internationalTourCountry", "internationalTourSeasonYear", "isPlayerControlled", "name", "nilBudget", "prestige", "saveGameId", "state", "venueCapacity" FROM "Team";
DROP TABLE "Team";
