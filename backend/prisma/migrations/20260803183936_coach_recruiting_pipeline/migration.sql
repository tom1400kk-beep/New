...
INSERT INTO "new_Coach" ("archetype", "background", "careerLosses", "careerWins", "collegeState", "collegeTeamName", "defenseSkill", "developmentSkill", "hotSeatLevel", "id", "isPlayerControlled", "legalityReputation", "name", "offenseSkill", "playedCollege", "proCountry", "proPath", "recruitingSkill", "reputation", "saveGameId", "yearsAtCurrentJob") SELECT "archetype", "background", "careerLosses", "careerWins", "collegeState", "collegeTeamName", "defenseSkill", "developmentSkill", "hotSeatLevel", "id", "isPlayerControlled", "legalityReputation", "name", "offenseSkill", "playedCollege", "proCountry", "proPath", "recruitingSkill", "reputation", "saveGameId", "yearsAtCurrentJob" FROM "Coach";
DROP TABLE "Coach";
