...
INSERT INTO "new_Player" ("athleticism", "basketballIq", "characterRating", "chemistryImpact", "classYear", "countryOfOrigin", "defense", "disciplineRating", "droppedForDiscipline", "eligibilityYearsLeft", "finishing", "firstName", "heightInches", "hometownCity", "hometownState", "id", "inTransferPortal", "injuryType", "injuryWeeksLeft", "isInjured", "isSuspended", "lastName", "onScholarship", "origin", "playmaking", "position", "potential", "previousSchool", "prioritiesJson", "rebounding", "saveGameId", "scoring", "stamina", "suspensionDaysLeft", "teamId", "threePoint") SELECT "athleticism", "basketballIq", "characterRating", "chemistryImpact", "classYear", "countryOfOrigin", "defense", "disciplineRating", "droppedForDiscipline", "eligibilityYearsLeft", "finishing", "firstName", "heightInches", "hometownCity", "hometownState", "id", "inTransferPortal", "injuryType", "injuryWeeksLeft", "isInjured", "isSuspended", "lastName", "onScholarship", "origin", "playmaking", "position", "potential", "previousSchool", "prioritiesJson", "rebounding", "saveGameId", "scoring", "stamina", "suspensionDaysLeft", "teamId", "threePoint" FROM "Player";
DROP TABLE "Player";
