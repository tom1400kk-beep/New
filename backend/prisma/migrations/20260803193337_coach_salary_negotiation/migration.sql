...
INSERT INTO "new_Coach" ("adRelationshipsJson", "archetype", "background", "careerLosses", "careerWins", "collegeState", "collegeTeamName", "defenseSkill", "developmentSkill", "hometownState", "hotSeatLevel", "id", "isPlayerControlled", "legalityReputation", "name", "offenseSkill", "pipelineStatesJson", "playedCollege", "proCountry", "proPath", "recruitingSkill", "reputation", "saveGameId", "yearsAtCurrentJob") SELECT "adRelationshipsJson", "archetype", "background", "careerLosses", "careerWins", "collegeState", "collegeTeamName", "defenseSkill", "developmentSkill", "hometownState", "hotSeatLevel", "id", "isPlayerControlled", "legalityReputation", "name", "offenseSkill", "pipelineStatesJson", "playedCollege", "proCountry", "proPath", "recruitingSkill", "reputation", "saveGameId", "yearsAtCurrentJob" FROM "Coach";
DROP TABLE "Coach";
...
INSERT INTO "new_Team" ("academicReputation", "athleticDirectorId", "conferenceId", "division", "facilitiesRating", "headCoachId", "id", "internationalScoutingRating", "isPlayerControlled", "name", "nilBudget", "prestige", "saveGameId", "state") SELECT "academicReputation", "athleticDirectorId", "conferenceId", "division", "facilitiesRating", "headCoachId", "id", "internationalScoutingRating", "isPlayerControlled", "name", "nilBudget", "prestige", "saveGameId", "state" FROM "Team";
DROP TABLE "Team";
