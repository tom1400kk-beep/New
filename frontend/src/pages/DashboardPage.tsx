    ...
    return (
      <div>
        ...
        <div className="card">
          ...
          {jobOffers.map((o) => (
            <div key={o.teamId} style={{ padding: "8px 0", borderBottom: "1px solid #262b36" }}>
  ...
  return (
    <div>
      ...
      <div className="card" style={{ display: "flex", gap: 32, flexWrap: "wrap" }}>
        <div>
          <div style={{ color: "#9aa4b2", fontSize: "0.8rem" }}>Record</div>
          <div style={{ fontSize: "1.4rem" }}>{record.wins}-{record.losses}</div>
        </div>
        <div>
          <div style={{ color: "#9aa4b2", fontSize: "0.8rem" }}>Conference</div>
          <div style={{ fontSize: "1.4rem" }}>{record.confWins}-{record.confLosses}</div>
        </div>
        <div>
          <div style={{ color: "#9aa4b2", fontSize: "0.8rem" }}>Prestige</div>
          <div style={{ fontSize: "1.4rem" }}>{team.prestige}</div>
        </div>
        <div>
          <div style={{ color: "#9aa4b2", fontSize: "0.8rem" }}>NIL Budget</div>
          <div style={{ fontSize: "1.4rem" }}>{fmtMoney(team.nilBudget)}</div>
        </div>
        <div>
          <div style={{ color: "#9aa4b2", fontSize: "0.8rem" }}>Hot Seat</div>
          <div style={{ fontSize: "1.4rem", color: team.headCoach.hotSeatLevel > 60 ? "#ff6b6b" : "inherit" }}>
      ...
      {events.length > 0 && (
        <div className="card" style={{ borderColor: "#ff7a00" }}>
